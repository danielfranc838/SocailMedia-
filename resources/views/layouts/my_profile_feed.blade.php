...
<div class="sd-title">
<h3>Most Viewed Profile</h3>
<i class="la la-ellipsis-v"></i>
</div>
<div class="suggestions-list">
{{-- view profile --}}
@include('includes.mostView')
{{-- end view profile --}}
<div class="view-more">
...
<a href="{{ route('user_profile') }}" title="">Status</a>
</div>
...
{{-- End sample Manage jobs post --}}
</div>


<div class="tab-pane fade" id="saved" role="tabpanel" aria-labelledby="saved-tab">

{{-- Begining Saved JObs post --}}
<div class="post-bar">
...
{{-- Sample Applied Candidates --}}
<div class="post-bar">
<div class="post_topbar applied-post">
<div class="usy-dt">
<img src="images/resources/us-pic.png" alt="">
<div class="usy-name">
<h3>Sample Applied Candidates</h3>
...
{{-- End of sample Bidsmanage post --}}
</div>



<div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
    {{-- Sample My Active bids post --}}
<div class="post-bar">
...
<a href="{{ route('setting') }}" title=""><i class="fas fa-cog"></i> Setting</a>
</div>
