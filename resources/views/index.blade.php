...
<body>
<div class="wrapper">
{{-- header component found in includes.header --}}
...
<li>
<a href="my-profile-feed.blade.php" title="">View Profile</a>
</li>
</ul>
</div>
...
<p><img src="images/cp.png" alt="">{{ env('COPY_RIGHT') }}</p>
</div>
</div>
</div>
</div>
...
<div class="sign_link">
<h3><a href="{{ route('login') }}" title="">Sign up</a></h3>
